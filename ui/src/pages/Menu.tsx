...
export function Menu() {
    ...
    const createMonthInfo = (date: Date) => {
        ...
        return { name: `${date.getFullYear()} ${date.toLocaleString('default', { month: 'long' })}`, startDate: startDate, endDate: endDate };
    }
    ...
    return (
        <main class="layout">
            ...
            <section class="content">
                ...
                {menu === "Home" && <Home selectedMonth={monthList.find((item => item.name == selectedMonth))} />} {/* Render Home component */}
