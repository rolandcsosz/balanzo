...
const models: TsoaRoute.Models = {
    ...
    "LoginSuccessResponse": {
        "dataType": "refObject",
        "properties": {
            "role": {"dataType":"union","subSchemas":[{"dataType":"enum","enums":["user"]},{"dataType":"enum","enums":["caregiver"]}],"required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/transaction_types',
            ...
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsTransactionTypeController_getAll, request, response });
        ...
        app.get('/transactions/:id',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsTransactionController_getOne, request, response });
        ...
        app.post('/templates',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsTemplateController_create, request, response });
        ...
        app.get('/templates',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsTemplateController_getAll, request, response });
        ...
        app.get('/templates/:id',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsTemplateController_getOne, request, response });
        ...
        app.put('/templates/:id',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsTemplateController_update, request, response });
        ...
        app.delete('/templates/:id',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsTemplateController_delete, request, response });
        ...
        app.get('/subcategories',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsSubcategoryController_getAll, request, response });
        ...
        app.get('/subcategories/:id',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsSubcategoryController_getOne, request, response });
        ...
        app.post('/subcategories',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsSubcategoryController_create, request, response });
        ...
        app.put('/subcategories/:id',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsSubcategoryController_update, request, response });
        ...
        app.delete('/subcategories/:id',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsSubcategoryController_delete, request, response });
        ...
        app.post('/main_categories',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsMainCategoryController_create, request, response });
        ...
        app.get('/main_categories',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsMainCategoryController_getAll, request, response });
        ...
        app.get('/main_categories/:id',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsMainCategoryController_getOne, request, response });
        ...
        app.put('/main_categories/:id',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsMainCategoryController_update, request, response });
        ...
        app.delete('/main_categories/:id',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsMainCategoryController_delete, request, response });
        ...
        app.get('/expense_types',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsExpenseTypeController_getAll, request, response });
